...
export const sampleStories: Story[] = [
  {
    id: 'story-1',
    title: 'Regenerative Banking Revolution',
    description: 'Navigate the complex dynamics of the modern fincial institutions, resource disparity, and control/power dynamics ',
    goal: "Identify and exemplify actionable plans for create a scalable impact, while preserving autonomy and develop a regenerative community restoring balance of resource accessibility, begining from a access disparity where your character's \"social class\" comprises the majority of humanity, but with access to only 5% of the resources against a minority of humanity with 95% of the resources.",
    beats: [
      {
        id: 'beat-1-1',
        text: 'Legacy Banking attempts to control/enslave humanity through Usury/debt  .',
        order: 1,
      },
      {
        id: 'beat-1-2',
        text: 'A community of stewards divests, withdrawing their finances from banks and creating community regenerative resource banks.',
        order: 2,
      },
      {
        id: 'beat-1-3',
        text: 'The community invest in land stewardship, infrastructure and biome regeneration.',
        order: 3,
      },
      {
        id: 'beat-1-4',
        text: 'Legacy institutions are faced with a choice. Evolve or collapse.',
        order: 4,
      },
      {
        id: 'beat-1-5',
        text: 'Communities gain access to sustainable resources and thrive.',
        order: 5,
      },
    ],
  },
